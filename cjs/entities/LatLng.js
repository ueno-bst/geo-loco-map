...
exports.LatLngBounds = exports.LatLng = exports.Rectangle = exports.Point = void 0;
const Types_1 = require("../utils/Types");
const Initialize_1 = require("./Initialize");
const GeoHash_1 = require("./GeoHash");
(0, Initialize_1.init)();
const math = Math, min = math.min, max = math.max, pow = math.pow;
const is_array = Types_1.isArray, is_null = Types_1.isNull, is_number = Types_1.isNumber, is_object = Types_1.isObject, is_instance_of = Types_1.isInstanceOf;
...
class LatLng {
    ...
    static fromHash(hash) {
        return GeoHash_1.GeoHash.decode(hash);
    }
    hash(length) {
        return GeoHash_1.GeoHash.encode(this, length);
    }
    /**
     * 2点の値が同一かを検証する
     * @param p
