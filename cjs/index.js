...
exports.GeoLocoMap = void 0;
const LatLng_1 = require("./entities/LatLng");
const IController_1 = __importDefault(require("./controllers/IController"));
class GeoLocoMap extends IController_1.default {
    constructor(config) {
        super(config);
    }
    request() {
    ...
    setCenter(lat, lng) {
        return this.controller.setCenter(new LatLng_1.LatLng(lat, lng));
    }
    addMarker(...markers) {
        // ユーザー用マーカーとして認識する
