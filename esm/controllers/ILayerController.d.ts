...
export declare abstract class ILayerController {
...
export declare abstract class IMessageLayerController extends ILayerController {
    /**
     * HTMLをメッセージとして出力する
     * @param html
     */
...
export declare abstract class IGridLayerController extends ILayerController {
    /**
     * 範囲要素を追加する
     * @param bounds
     */
...
export declare abstract class IDebugLayerController extends ILayerController {
    abstract setClasses(...classes: string[]): this;
    abstract setBound(rectangle: LatLngBounds): this;
}
//# sourceMappingURL=ILayerController.d.ts.map